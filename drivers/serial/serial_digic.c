...
{
	while (!(digic_serial_readl(cdev, DIGIC_UART_ST) & DIGIC_UART_ST_TX_RDY))
		; /* noop */
...
{
	while (!(digic_serial_readl(cdev, DIGIC_UART_ST) & DIGIC_UART_ST_RX_RDY))
		; /* noop */
...
{
	return ((digic_serial_readl(cdev, DIGIC_UART_ST) & DIGIC_UART_ST_RX_RDY) != 0);
