...
static int mt7621_spi_transfer_one_message(struct spi_device *spi,
...
static int mt7621_spi_probe(struct device_d *dev)
{
	...
	master->transfer = mt7621_spi_transfer_one_message;
	master->num_chipselect = 2;

	spi_controller_set_devdata(master, rs);
	rs->base = base;
	rs->clk = clk;
	...
	return spi_register_controller(master);
}
